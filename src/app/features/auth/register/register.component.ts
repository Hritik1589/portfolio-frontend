...
export class RegisterComponent implements AfterViewInit {
  ...
  moveButton(event: MouseEvent) {
    ...
    this.buttonX.set((x - rect.width / 2) / 7);
    this.buttonY.set((y - rect.height / 2) / 7);
  }
  ...
  calculateStrength(password: string) {
    ...
    if (score < 40) this.passwordStrengthLabel.set('Weak');
    else if (score < 70) this.passwordStrengthLabel.set('Medium');
    else if (score < 90) this.passwordStrengthLabel.set('Strong');
    else this.passwordStrengthLabel.set('Excellent');
  }
